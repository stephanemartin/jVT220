...
import static nl.lxtreme.jvt220.terminal.vt220.VT220Parser.BELL;
...
public class TerminalClient {
    ...
    public boolean isAlarmOn() {
        return terminal.isAlarmSounded();
    }

    public boolean resetAlarm() {
        boolean ret = terminal.isAlarmSounded();
        terminal.setAlarmSounded(false);
        return ret;
    }
}
